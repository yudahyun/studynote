...
async function get_search() {
  ...
  //선택한 카테고리 가져오기
  const category = document.querySelector("#source").value;
  ...
  if (json != null) {
    ...
    data.documents.map((v, i) => {
     ...
     const hourTime =  parseInt(v.datetime.substring(11, 13));
     let hourTime2 ="";
     ...
     if(hourTime < 12){
      ...
      str = "오후 "
      hourTime2 = hourTime - 12;
     }
     time.innerHTML = v.datetime.substring(0, 10) +str+ hourTime2+":" + v.datetime.substring(14, 16)  ;

   

      const Name = document.createElement("span");

      Name.innerHTML = v[Object.keys(v)[0]];
